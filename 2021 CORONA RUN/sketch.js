...
smith_running = loadAnimation ("smith1.png","smith2.png","smith3.png","smith4.png","smith5.png","smith6.png","smith7.png","smith8.png");
smith_collided = loadAnimation ("smith9.png");

pathImg = loadImage ("path.png");

obstacle1 = loadImage("obstacle01.png");
obstacle2 = loadImage("obstacle02.png");
obstacle3 = loadImage("obstacle03.png");
...
function setup() { 
   ...
   smith.setCollider('circle',0,0,120);
   smith.scale = 0.200;
    ...
    if (gameState===PLAY){
      ...
      smith.changeAnimation("collided", smith_collided);
